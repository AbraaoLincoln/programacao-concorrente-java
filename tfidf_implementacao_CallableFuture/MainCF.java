...
public class MainCF{
	...
	public static void main(String[] args) throws InterruptedException{
		Dataset.sharedDataset = new Dataset("./dataset_big");
	...
	public static void printResult(ArrayList<Word> listOfWords) {
		...
		ArrayList<Future> listOfFuture =  new ArrayList<>();
		
		for(int i = 0; i < listOfWords.size(); i++) {
			Future<ArrayList<Double>> future = executor.submit((Callable<ArrayList<Double>>) listOfWords.get(i));
		...
		for(int i = 0; i < docs.length; i++) {
			System.out.print(docs[i].getName() + " ");
		}
		
		System.out.println("");
		System.out.println("-----------------------------");
		int wordIndex = 0;
		for(Future<ArrayList<Double>> tfIdfOfWord : listOfFuture) {
			System.out.print(listOfWords.get(wordIndex).getValue() + " ");
			try {
				ArrayList<Double> tfIdfs = tfIdfOfWord.get();
				for(int i = 0; i < tfIdfs.size(); i++) {
					System.out.print(tfIdfs.get(i) + " | ");
				}
				System.out.println("");
				System.out.println("---------------------------------------------------------------");
				wordIndex++;
	...
	public static String[] get1000Words() {
